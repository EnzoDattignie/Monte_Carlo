...
int main (int argc, char *argv[]) {
    int ndim, n , seed = 22, n_cycles = 102000, current_cycle = 0, *Liste_Verlet;
    double lmax = 0.15, P, kT = 0.05;
    char *input_file = "input_Phase_V.xyz";
    if (argc > 1) {
    ...
    xyz = fopen("res/out_Phase_V.xyz","w");
    save_xyz(xyz, pos,0,n,ndim,kT);

    log = fopen("res/out_Phase_V.log","w");
